...
-  **y~i~** is the average score or driving distance of course ***i***.
...
$$
score_i = \beta_0 + \beta_1 \cdot yardage_i + \epsilon_i
$$
Where:
...
- *yardage~i~* is the yardage for the *i*-th observation
